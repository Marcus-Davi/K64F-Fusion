...
static void StateFunction(const float* Xk,const float *Uk,arm_matrix_instance_f32* M){
	//Uk -> entrada gyro 3x1
...
static void MeasurementFunction(const float* Xk,const float *Uk,arm_matrix_instance_f32* M){
